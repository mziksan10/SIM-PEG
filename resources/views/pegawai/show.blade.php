                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="col-lg-3 col-md-4 card">
                            <div class="modal-dialog-centered justify-content-center ml-2" style="width:100%">
                                <div style="max-height: 500px; max-width: 250px; overflow: hidden;">
                                    ...
                                    <div class="badge badge-primary align-middle small" style="width:100%">{{ $thn." Tahun" }} <br> {{ $bln." Bulan ".$tgl." Hari" }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
